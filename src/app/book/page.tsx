            ...
            <div className="mb-8 relative z-10">
              ...
              <div className="grid grid-cols-7 gap-2">
                ...
                {Array.from({ length: daysInMonth }).map((_, index) => {
                  ...
                  let style = "text-white/60 hover:text-white hover:bg-white/5 transition-colors cursor-pointer";
                  if (isSelected) style = "bg-primary text-[#0a0a0a] font-bold shadow-[0_0_15px_rgba(212,175,55,0.4)] cursor-pointer";
                  return (
            ...
            <div className="mt-auto relative z-10">
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
                {timeSlots.map((time, index) => {
                  ...
                  let style = "border-white/10 text-white/60 hover:border-primary hover:text-primary transition-all bg-[#1e1f23]/50 cursor-pointer";
                  if (isSelected) style = "border-primary text-primary transition-all bg-primary/10 relative overflow-hidden cursor-pointer shadow-[0_0_15px_rgba(212,175,55,0.4)]";
                  return (
              ...
              <div className="mt-8 pt-6 border-t border-white/5 flex justify-end">
                <button
                  ...
                  className="px-8 py-4 rounded-lg font-montserrat font-bold uppercase tracking-widest flex items-center gap-2 transition-all duration-300 hover:shadow-[0_0_25px_rgba(212,175,55,0.5)]"
